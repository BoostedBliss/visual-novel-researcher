// Web Audio API Synthesizer for Anime Visual Novel Sound Effects
...
class SoundManager {
  ...
  // Soft dialogue character voice blip (pitch-modulated)
  public playSpeechBlip(pitch = 440) {
    ...
    try {
      ...
      osc.frequency.exponentialRampToValueAtTime(pitch * 0.95, ctx.currentTime + 0.04);
